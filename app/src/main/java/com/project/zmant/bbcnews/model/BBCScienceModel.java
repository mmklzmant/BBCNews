...
/**
 * @author zmant 2016/12/16 16:02
 * @classname BBCScienceModel
 * @description  BBC模块 Science Fragment Model层
 */

public class BBCScienceModel {
    private BBCSciencePresenter mPresenter;
    public BBCScienceModel(BBCSciencePresenter presenter)
    {
    ...
    private ArrayList<BBCCardViewBean> parseHtml(String html) {
        ...
        datas = mergeScience(titles, urls, imgurls, times, locations);
        return datas;
    }
     ...
     */
    private ArrayList<BBCCardViewBean> mergeScience(ArrayList<String> titles,ArrayList<String> urls,
