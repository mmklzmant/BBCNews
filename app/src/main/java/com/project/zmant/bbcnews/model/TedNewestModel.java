...
/**
 * @author zmant 2016/12/26 10:19
 * @classname
 * @description
 */

public class TedNewestModel {
    private TedNewestPresenter mPresenter;
    public TedNewestModel(TedNewestPresenter presenter)
    {
    ...
    private ArrayList<TedCardViewBean> parseHtmlTed(String html) {
        ...
        try {
            ...
            arrayItems = array.optJSONObject(0).getJSONArray("items");
