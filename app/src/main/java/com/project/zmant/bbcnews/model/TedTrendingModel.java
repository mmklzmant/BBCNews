...
/**
 * @author zmant 2016/12/26 10:40
 * @classname TedTrendingModel
 * @description Ted模块Trending Model层
 */

public class TedTrendingModel {
    private TedTrendingPresenter mPresenter;

    public TedTrendingModel(TedTrendingPresenter presenter)
    {
    ...
    private ArrayList<TedCardViewBean> parseHtmlTed(String html) {
        ...
        try {
            ...
            arrayItems = array.optJSONObject(1).getJSONArray("items");
